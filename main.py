...
img2 = ImageTk.PhotoImage(PILImage.open(path1))
panel1 = tk.Label(window, image = img2)
panel1.place(x = 90, y = 250)

# image on the main window
path = "Images/front1.png"
img1 = ImageTk.PhotoImage(PILImage.open(path))
...
if exit1==False:
    ...
    def image_option():
        ...
        nhãn_số_lượng = tk.Label(windowi, font=("Arial", 30), fg="red")
        nhãn_số_lượng.place(x=100, y=495)
        max_count1 = 0
        framex1 = []
        county1 = []
        max1 = []
        ...
        def detectByPathImage(path):
            ...
            max_acc1 = 0
            max_avg_acc1 = 0
            # nhãn_số_lượng.config(text="Số người được phát hiện: " + str(person))
